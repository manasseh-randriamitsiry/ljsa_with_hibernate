...
@Entity
@Table(name = "seconde", schema = "ljsa")
public class SecondeEntity {
    ...
    public double getTotal() {
        return malagasy+ francais+ anglais+ histogeo+ eac+ ses+ spc+ svt+ mats+ eps+ tice;
